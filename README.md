...
- [ ] Explain benefit(s) using `client-side routing`?
  > Answer: It allows you to navigate through the app without multiple trips to the server. All of the information is contained within the app, making it very performant.
- [ ] What does AJAX stand for?
  > Answer: Asynchronous Javascript and XML
- [ ] What are `controlled components` in React?
  > Answer: Controlled components are very useful in that they receive their values in a stately way, allowing for a multiplicity of effects, including real-time updating.
- [ ] Name three tools/libraries for making AJAX requests.
  > Answer: jQuery, axios, fetch
